...
def train(model, optimizer, loss_fn, train_loader, val_loader,
    ...
    def log_training_loss(engine):
        print(
            ...
            f"{len(train_loader)}] Loss: {engine.state.output}"
        )
    ...
    def log_training_results(engine):
        ...
        print(
            f"Training Results - Epoch: {engine.state.epoch} Avg loss: {avg_loss}"
        )
    ...
    def log_validation_results(engine):
        ...
        print(
            f"Validation Results - Epoch: {engine.state.epoch} Avg loss: {avg_loss}"
        )
